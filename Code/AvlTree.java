...
public class AvlTree<AnyType extends Comparable<? super AnyType>> 
{
    ...
    private AvlNode<AnyType> balance( AvlNode<AnyType> t )
    {
        ...
        if( height( t.right ) - height( t.left ) > ALLOWED_IMBALANCE )
            if( height( t.right.right ) >= height( t.right.left ) )
                ...
                t = doubleWithRightChildVersion2( t );
    ...
    * Rotate binary tree node with right child.
     * Pretty much same as rotateWithLeftChild
    */
    ...
    /**
     * Calls first rotation with left child
     * then calls right rotation with right child
     * @param k2
     * @return single rotation with right
     */
    ...
    /**
     * Second version of doubleWithRightChild without recursion
     * @param k2
     * @return
     */
